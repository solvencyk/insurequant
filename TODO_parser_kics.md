...
**2026-07-07 9차 — 적용후(after-capture) 전체 룰 재검증 대응 + item12 셀밀림: 8개 근본버그 수정, RED 159→104 + item12 154→60.**
...
- [ ] **item12 잔여 60셀, 16개사** (KR0099 13·KR0068 12·KR0073 10이 최대 군집): 남은 헤더-파싱/baseline
  변형이 회사마다 제각각이라 긴 꼬리(long-tail) 패턴으로 전환됨 — 더 파려면 회사별 개별 조사 필요, 시간
  대비 수익 체감 구간. 우선순위 낮음, 후속 세션에서 회사별 표본 확인 권고.
