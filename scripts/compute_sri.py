...
ASSETS = [
    # Use the canonical npm dist file chart.umd.js (exists in the package, byte-identical
    # across jsDelivr/unpkg). NOT chart.umd.min.js — that one is auto-generated by jsDelivr
    # (absent from npm), so it cannot be cross-verified against an independent CDN.
    ("chart.js@4.4.0",
