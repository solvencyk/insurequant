"""Before/after diff census of root PL_breakdown.json after build_pl() ran off the 2026.1Q
item6 surgical patch. Same shape as mirae_2025q2q3_diff_census.py.
"""
import json
import sys
...
before = json.loads((ROOT / "PL_breakdown.json.snapshot_pre_build_20260829_mirae2026q1")
...
print(f"key sets identical: {set(before_idx) == set(after_idx)}")
