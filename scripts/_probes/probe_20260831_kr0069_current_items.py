...
items = sorted(set(int(r["항목번호"]) for r in rows if r["원보험사코드"]=="KR0069" and r["공시분기"]=="2026.2Q" and str(r["항목번호"]).isdigit()))
print("KR0069 2026.2Q items after stage A (current MD):", items)
missing_1_28 = [i for i in range(1,29) if i not in items]
print("missing from 1-28:", missing_1_28)
