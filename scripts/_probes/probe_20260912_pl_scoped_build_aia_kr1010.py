# -*- coding: utf-8 -*-
"""Scoped rebuild for the AIA-456 + KR1010 follow-up (inbox/parser/20260901T1630Z round 2,
2026-09-12): KR0080(AIA) 주석18(4)/19(3) 정밀 소스 전환 + KR1010(교보라이프플래닛) 2023.4Q
item2/item16 _GOLD_CELL_OVERRIDE 정정.

Mirrors scripts/_probes/probe_20260912_pl_scoped_build_aia.py's pattern: re-parse ONLY these
2 companies via discover_filings/parse_filing/assemble and UNION-MERGE the resulting rows into
data/dart/viz/pl_breakdown_master.json + pl_breakdown_coverage.json by company key -- every
other company's rows pass through untouched. This is the company-scoped call CLAUDE.md requires
instead of build_pl_breakdown.main() (full 39-company rebuild, higher blast radius)."""
