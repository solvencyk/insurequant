...
before_path = Path(r"C:\Users\sangwook.cho\Desktop\insurequant\artifacts\kics_validation\report_20260831T114325Z.json")
after_path = Path(r"C:\Users\sangwook.cho\Desktop\insurequant\artifacts\kics_validation\report_20260831T114312Z.json")
...
for k in sorted(new_red, key=lambda x: (str(x[0]), str(x[1]), str(x[2]))):
    f = a_red[k]
    print(f"  {k}  detail={f.get('detail')!r}")
print()
