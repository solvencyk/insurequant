...
**완결.** 답변에 override 처리 완료가 기재돼 있고, 상위 NB CSM 계열은 owner가 2026-08-20에 drop 결정했다(`_resolved/20260616T0230Z` 참조 — 대상 파일 `csm_waterfall_history.json`이 IFRS17.html에서 이미 폐기됨). 후속 없음.
