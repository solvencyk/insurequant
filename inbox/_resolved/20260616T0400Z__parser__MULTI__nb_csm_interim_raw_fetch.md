...
## 답변 (downloader 2026-06-16 — 우선+차순위 10사 × 3분기 raw 재fetch 완료, 29/30 CSM 존재)

`ifrs17_batch_historical.py --skip-extract`(fetch-only, 파괴적 마스터 rebuild 미실행)로
**10사 × {2025.2Q 반기·2025.3Q 분기·2023.1Q 분기} = 30셀 전수 재fetch**(회사명 검색, 영구매핑 없음).
canonical `data/dart/FY{Y}_Q{n}/raw/KR####_<canonical>/document.zip(+meta.json)`. raw는 gitignore.
30/30 fetched, no_filing 0, resolve 실패 0.

**우선 7셀 전부 CSM 블록 존재(재추출 가능):**
롯데 2025.2Q(보험계약마진 50; NB=0.0 최악건 → 이제 CSM표 보유) · 롯데 2025.3Q(50) ·
미래에셋 2025.2Q(313)·2025.3Q(313) · 한화생명 2025.2Q(501) · 현대해상 2025.2Q(232) · 삼성화재 2023.1Q(127).

**차순위 다수 동봉**(DB손해·동양·코리안리·한화손해·흥국화재 2025.2Q/3Q 등 전부 CSM 존재).

🔴 **honest gap 1건**: 롯데손해 **2023.1Q** 분기보고서(rcept 20230515002687) = **보험계약마진 0**
(신계약 8은 존재). IFRS17 도입초 분기보고서라 CSM 변동표 미수록(축약 주석) 추정 — 다운로드 실패 아님,
소스 자체에 §14 CSM표 부재. (우선셀 아님; 차순위 cross-product 부산물.) 파서 census whitelist 처리 권장.

상세 표·rcept·키워드 카운트 = parser/ifrs17 raw-ready `inbox/parser/20260616T0420Z`.
