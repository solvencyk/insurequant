# -*- coding: utf-8 -*-
"""Write the overnight morning report (UTF-8, no BOM)."""
from pathlib import Path
ROOT = Path(__file__).resolve().parents[1]

REPORT = """# 아침 보고서 — CSM & PL 야간 자율작업 (2026-06-03)
...
(ROOT / "docs" / "MORNING_REPORT_2026-06-03.md").write_text(REPORT, encoding="utf-8")
print("wrote docs/MORNING_REPORT_2026-06-03.md")
print(REPORT[:200])
