...
**PL Tier-2 follow-up — 검증 결과 대부분 이미 해소(아래 "NEXT 2026-06-06 (b)" 1~5 노트는 stale):**
worktree 에이전트는 세션 한도로 미완(probing만)이었으나, 메인이 실제 상태 검증 → 미래에셋 분기
item1/2/4 정상 백만원 · 한화손해 13/14 전분기 채워짐(2023.1Q/2Q FY2023만 blank) · 롯데 Tier-2
2024.2Q/3Q·2025.3Q·2026.1Q 채워짐. **잔여 = FY2023 early(비노출 deferred) + 롯데 2025.2Q(반기보고서
LOB 컴포넌트노트 부재, 반기 한계).** 전부 pl_bridge 게이트 실패 아님(item1은 Tier-1로 reconcile). 저영향.
